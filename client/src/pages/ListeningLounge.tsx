...
export default function ListeningLounge() {
  return (
    <div className="pt-20 min-h-screen bg-deep-black">
            ...
            >
              ...
              <div className="flex items-center justify-center gap-12">
                ...
                >
                  ...
                  <span
                    className="text-xs text-white/50 uppercase tracking-wider group-hover:text-green-500 transition-colors"
                    style={{ fontFamily: "'Chakra Petch', sans-serif" }}
                  >
                    Spotify
                  </span>
                ...
                >
                  ...
                  <span
                    className="text-xs text-white/50 uppercase tracking-wider group-hover:text-pink-500 transition-colors"
                    style={{ fontFamily: "'Chakra Petch', sans-serif" }}
                  >
                    Apple Music
                  </span>
                ...
                >
                  ...
                  <span
                    className="text-xs text-white/50 uppercase tracking-wider group-hover:text-cyan-400 transition-colors"
                    style={{ fontFamily: "'Chakra Petch', sans-serif" }}
                  >
                    Tidal
                  </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="max-w-4xl mx-auto">
              ...
              >
                <iframe
                  src="https://www.youtube.com/embed/bpmVy6V-R3E?si=6bSv3z-D3oeWmOCU"
              ...
              <div className="text-center mt-6">
                <h3
                  ...
                  style={{ fontFamily: "'Chakra Petch', sans-serif" }}
                >
                  My Prayer - OFFICIAL MUSIC VIDEO
                </h3>
      ...
      <section className="py-8 md:py-20 bg-gradient-to-b from-deep-black via-black/95 to-deep-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-6">
              {STREAMING_PLATFORMS.map((platform, index) => (
                ...
                >
                  <i
                    className={`${platform.icon} text-2xl mr-3 group-hover:text-cyan-400 transition-colors duration-300`}
                  ></i>
